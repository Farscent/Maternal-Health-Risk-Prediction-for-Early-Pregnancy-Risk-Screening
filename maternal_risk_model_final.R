...
# flagged unnecessarily, adding follow-up workload). 
# We compare 0.5 against a lower cutoff of 0.3 to illustrate this tradeoff; 
# the appropriate cutoff in practice should be chosen with clinical input on the acceptable
